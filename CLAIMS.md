...
|---|---|---:|---|
| C001 | The workflow uses structured backlog issues as execution contracts. | demonstrated-private | Private `dark-factory` and `ai-os` issues define goals, acceptance criteria, and workflow constraints. |
...
| C003 | The workflow separates implementation from review/judgment responsibilities. | demonstrated-private | Private `dark-factory` work includes reviewer/judge concepts and persisted AI-judge outcome handling. |
...
| C005 | The workflow detects provider/harness availability before starting doomed runs. | demonstrated-private | Private `dark-factory` provider availability preflight work has been implemented and merged. |
